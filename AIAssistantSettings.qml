...
Item {
    ...
    property bool customBrowserSearch: false
    ...
    function normalizedProfile(id, raw) {
        ...
        if (id === "inception") {
            ...
            profile.customBrowserSearch = (typeof p.customBrowserSearch === "boolean") ? p.customBrowserSearch : !!d.customBrowserSearch
        }
        return profile
    }
    ...
    function applyActiveProfile() {
        ...
        customBrowserSearch = !!active.customBrowserSearch
    }
    ...
    function setProvider(providerId) {
        ...
        save("customBrowserSearch", !!active.customBrowserSearch)
    }
    ...
    function saveActiveField(key, value) {
        ...
        if (["baseUrl", "model", "apiKey", "saveApiKey", "apiKeyEnvVar", "temperature", "maxTokens", "geminiWebSearch", "customBrowserSearch"].includes(key)) {
    ...
    function load() {
        ...
        if (!rawProviders || typeof rawProviders !== "object") {
            const legacyProfile = {
                ...
                customBrowserSearch: PluginService.loadPluginData(pluginId, "customBrowserSearch", false)
            }
                            ...
                            Column {
                                ...
                                RowLayout {
                                    ...
                                    Column {
                                        ...
                                        StyledText {
                                            text: I18n.tr("Browser search")
                                            font.pixelSize: Theme.fontSizeMedium
                                            color: Theme.surfaceText
                                        }

                                        StyledText {
                                            text: I18n.tr("Groq built-in tool (openai/gpt-oss models only). Runs server-side, no local setup needed.")
                                            font.pixelSize: Theme.fontSizeSmall
                                            color: Theme.surfaceVariantText
                                            wrapMode: Text.WordWrap
                                            width: parent.width
                                    ...
                                    DankToggle {
                                        checked: root.customBrowserSearch
                                ...
                                StyledText {
                                    width: parent.width
                                    visible: root.provider === "custom" && root.customBrowserSearch
                                    text: I18n.tr("Requires a Groq base URL and an openai/gpt-oss-20b or openai/gpt-oss-120b model. Not compatible with structured outputs.")
                                    font.pixelSize: Theme.fontSizeSmall
                                    color: Theme.surfaceVariantText
                                    wrapMode: Text.WordWrap
                                }
